...
<div class="main-custom">
	<div class="header-custom row">
		<div class="header-logo col-1">
			<div class="logo">
				<img src="<%=request.getContextPath()%>/resources/img/IdH로고2.jpg"
		...
		<div class="main-menu-custom col-11">
			<div class="menu">
				<i class="fa-solid fa-border-all"></i>&nbsp대시보드
			</div>
			<div class="menu">
				<i class="fa-solid fa-globe"></i>&nbsp사업관리
			</div>
			<div class="menu">
				<i class="fa-solid fa-keyboard"></i>&nbsp요구사항관리
			</div>
			<div class="menu">
			...
			<div class="menu">
				<i class="fa-solid fa-bell"></i>&nbsp공지사항
			</div>
			<div class="menu">
				<i class="fa-sharp fa-solid fa-book"></i>&nbsp표준관리
			</div>
		</div>
		<!--main-menu종료 -->
		<div class="col-12 sub-menu">
			<div class="top-menu">
				<nav class="left">
					<a href="#">내 작업</a> <a class="selected active-tab" href="#">업무관리</a>
					<a class="" href="#">회의관리</a>
				</nav>
			</div>
		</div>
