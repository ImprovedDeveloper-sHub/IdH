...
<div class="col-4" style="display: inline-block; border: 1px solid blue;">
	<a>testLink01</a><br/><a>testLink01</a><br/><a>testLink01</a><br/><a>testLink01</a><br/>
</div>

<div class="col-6" style="display: inline-block; border: 1px solid red; text-align: center;"><img src="<%=request.getContextPath()%>/resources/img/footerDesignSample.JPG" style="margin-top: 0px; width: 45%; height:auto; background-size: cover;"/></div>
