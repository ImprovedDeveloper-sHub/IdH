...
<div class="content">
   <div class="row" >
      <div class="col-7" >
      <div id="content" class="card" style="height: 612px" >
         ...
         <div  style="height:800px !important;">
            <div id="content" class="card" style="height: 612px" >
               ...
               <div class="card-tools"
                  style="justify-content: space-between; display: flex; flex-direction: row-reverse; margin:10px;">
                  ...
                  <button type="button" class="btn btn-block btn-info btn-sm"
                     style="width: 80px;"
                     onclick="OpenWindow('registForm','등록',680,680);">등록</button>
               </div>
                     ...
                     <table class="table table-hover">
                        ...
                        <tbody class="text-left">
                           ...
                           <c:forEach items="${requireList }" var="require">
                              <tr
                                 onclick="OpenWindow('detail?require_number=${require.require_number}','상세보기',682,610);">
                                 <td
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
               ...
               eventClick: function(info) {
                    ...
                    if (eventObj.url) {
                      ...
                      OpenWindow('<%=request.getContextPath()%>/projectManage/unitworkDetail?unitwork_number='+eventObj.url,'상세보기',680,543);
