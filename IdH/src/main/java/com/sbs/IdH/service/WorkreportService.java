...
public interface WorkreportService {
	...
	Map<String, Object> selectMyCheckList(SearchCriteria cri,HttpServletRequest request) throws SQLException;
	Map<String, Object> selectGetterCheckList(SearchCriteria cri,HttpServletRequest request) throws SQLException;
