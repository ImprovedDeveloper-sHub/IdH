...
public interface WorkService {
	...
	Map<String, Object> selectGetterWorkList(SearchCriteria cri, HttpServletRequest request)throws SQLException;
	Map<String, Object> selectMyWorkList(SearchCriteria cri, HttpServletRequest request) throws SQLException;
