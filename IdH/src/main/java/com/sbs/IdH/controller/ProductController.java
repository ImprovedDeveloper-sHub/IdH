...
//	}
//	
//	  @GetMapping("/cowork_detail") 
//	  public ModelAndView cowork_detail(int cowork_number, String from, RedirectAttributes rttr, ModelAndView mnv) throws Exception { String
