...
public class WorkVO {
	...
	public List<Work_AttachVO> getAttachList() {
		return attachList;
	}

	public void setAttachList(List<Work_AttachVO> attachList) {
	...
	public WorkVO(int work_number, int work_project_number, String work_member_id, int work_check, Date work_regdate,
			Date work_enddate, String work_member_approver, String work_title, String work_content,
			List<Work_AttachVO> attachList) {
		super();
		this.work_number = work_number;
		this.work_project_number = work_project_number;
		this.work_member_id = work_member_id;
