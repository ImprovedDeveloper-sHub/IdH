 ...
 * 
 * @Transactional public class TestIssueService {
 * 
 * @Autowired private IssueService issueService;
 * 
 * 
 * @Test public void testSelectIssue() throws SQLException{
 * issueService.selectIssue(1);
 * 
 * }
 * 
 * @Test public void testSelectIssueList() throws SQLException{ SearchCriteria
 * cri = new SearchCriteria(); issueService.selectIssueList(cri); }
 * 
 * @Test public void testInsertIssueList() throws SQLException{ IssueVO issue =
